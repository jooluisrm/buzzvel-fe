...
export const MainSection1 = () => {
    return (
        <main className="py-[48px] px-[16px] flex-1 lg:p-20" aria-labelledby="main-title">
            <div className="mt-96 text-center flex flex-col gap-[24px] md:mt-6 md:text-start">
                ...
                <blockquote className="text-[18px] leading-[28.8px]  max-w-[600px] lg:text-[24px] lg:leading-[38.4px]">Viverra viverra nibh enim et aliquam, enim. Tempor, sit mus viverra orci dui consequat turpis scelerisque.</blockquote>
            ...
            <div className="mt-[64px] flex flex-col gap-[16px]">
                ...
                <div className="flex items-center gap-[16px]">
                    <div>
                        <Image src={img} alt="Foto de Rwanda Melflor" />
                    </div>
                    <div>
                        <h4 className="text-[18px]">Rwanda Melflor</h4>
                        <span className="text-[16px] text-[#475569]">zerowaste.com</span>
                    </div>
                </div>
            </div>
        </main>
